...
switch what
    case 'targetfile'
        ...
        %need to change sequences
        Seq1 = [1 3 2 5 3 4 5 2 4; ...
            5 3 4 1 3 2 1 4 2; ...
            1 3 2 4 3 2 3 5 1; ...
            5 3 4 2 3 4 3 1 5; ...
            3 1 5 4 2 5 4 3 2 ; ...
        ...
        Chunks1 = [ 5 3 4; 1 3 2; 1 4 2; 4 3 2; 3 5 1; 3 1 5; 4 2 5; 5 2 4; 2 3 4; 2 4 1];
        ...
        OrderFields = {'startTime','seqNumb','seqType','press1','press2','press3','press4','press5','press6','press7','press8','press9','hand','cueS','cueC','cueP','iti','sounds','isScan','isMetronome','lastTrial','FoSEX'};
        
        GroupHand = 2;      % or 2 - define here!!! always change!!!
            ...
            for e = 1:13
                ...
                switch GroupHand
                    ...
                    case 1
                        ...
                        dsave(['sml_CLB_G1_R_B' num2str(e) '.tgt'],orderfields(ChunkTrain_G1,OrderFields));
                        dsave(['sml_CLB_G2_L_B' num2str(e) '.tgt'],orderfields(ChunkTrain_G2,OrderFields));
                        
                    case 2
                        
                        dsave(['sml_CLB_G2_R_B' num2str(e) '.tgt'],orderfields(ChunkTrain_G1,OrderFields));
                        dsave(['sml_CLB_G1_L_B' num2str(e) '.tgt'],orderfields(ChunkTrain_G2,OrderFields));
            ...
            %%  ChunkTrain Block Reversed
            
            Trials = 1:110;
            for e = 1:13
                
                ChunkTrainReverse_G1.cueS = cellstr(repmat('£',length(Trials),1));
                ChunkTrainReverse_G2.cueS = cellstr(repmat('£',length(Trials),1));
                
                ChunkTrainReverse_G1.iti(1:length(Trials),:) = 500;
                ChunkTrainReverse_G2.iti(1:length(Trials),:) = 500;
                
                ChunkTrainReverse_G1.hand(1:length(Trials),:) = 2;
                ChunkTrainReverse_G2.hand(1:length(Trials),:) = 1;
                
                ChunkTrainReverse_G1.sounds(1:length(Trials),:) = 1;
                ChunkTrainReverse_G2.sounds(1:length(Trials),:) = 1;
                ...
                for i = 1:(length(Trials)/2)
                    ...
                    ChunkTrainReverse_G1.cueP(p-1,:) = C3;
                    ChunkTrainReverse_G1.cueP(p,:) = regexprep(cellstr(num2str(ChunksG1(X(l),:))),'\s','');
                    ChunkTrainReverse_G2.cueP(p-1,:) = C3;
                    ChunkTrainReverse_G2.cueP(p,:) = regexprep(cellstr(num2str(6-ChunksG2(X(l),:))),'\s','');
                    
                    ChunkTrainReverse_G1.press1(p-1:p,:) = ChunksG1(X(l),1);
                    ChunkTrainReverse_G1.press2(p-1:p,:) = ChunksG1(X(l),2);
                    ChunkTrainReverse_G1.press3(p-1:p,:) = ChunksG1(X(l),3);
                    ChunkTrainReverse_G2.press1(p-1:p,:) = ChunksG2(X(l),1);
                    ChunkTrainReverse_G2.press2(p-1:p,:) = ChunksG2(X(l),2);
                    ChunkTrainReverse_G2.press3(p-1:p,:) = ChunksG2(X(l),3);
                    
                    ChunkTrainReverse_G1.seqNumb(p-1:p,:) = ChunkNumb(X(l));
                    ChunkTrainReverse_G2.seqNumb(p-1:p,:) = ChunkNumb(X(l));
                    
                    ChunkTrainReverse_G1.cueC(p-1:p,:) = C2(X(l),:) ;
                    ChunkTrainReverse_G2.cueC(p-1:p,:) = C2(X(l),:) ;
                ...
                ChunkTrainReverse_G1.press4 = zeros(length(Trials),1);
                ChunkTrainReverse_G1.press5 = zeros(length(Trials),1);
                ChunkTrainReverse_G1.press6 = zeros(length(Trials),1);
                ChunkTrainReverse_G1.press7 = zeros(length(Trials),1);
                ChunkTrainReverse_G1.press8 = zeros(length(Trials),1);
                ChunkTrainReverse_G1.press9 = zeros(length(Trials),1);
                
                ChunkTrainReverse_G2.press4 = zeros(length(Trials),1);
                ChunkTrainReverse_G2.press5 = zeros(length(Trials),1);
                ChunkTrainReverse_G2.press6 = zeros(length(Trials),1);
                ChunkTrainReverse_G2.press7 = zeros(length(Trials),1);
                ChunkTrainReverse_G2.press8 = zeros(length(Trials),1);
                ChunkTrainReverse_G2.press9 = zeros(length(Trials),1);
                
                ChunkTrainReverse_G1.isScan = zeros(length(Trials),1);
                ChunkTrainReverse_G2.isScan = zeros(length(Trials),1);
                
                ChunkTrainReverse_G1.seqType = zeros(length(Trials),1);
                ChunkTrainReverse_G2.seqType = zeros(length(Trials),1);
                
                ChunkTrainReverse_G1.FoSEX = repmat([1:2]',length(Trials)/2,1);
                ChunkTrainReverse_G2.FoSEX = repmat([1:2]',length(Trials)/2,1);
                
                ChunkTrainReverse_G1.isMetronome = zeros(length(Trials),1);
                ChunkTrainReverse_G2.isMetronome = zeros(length(Trials),1);
                
                ChunkTrainReverse_G1.lastTrial = zeros(length(Trials),1);
                ChunkTrainReverse_G2.lastTrial = zeros(length(Trials),1);
                
                ChunkTrainReverse_G1.startTime = zeros(length(Trials),1);
                ChunkTrainReverse_G2.startTime = zeros(length(Trials),1);
                
                switch GroupHand
                    case 1
                        dsave(['sml_CLRB_G1_R_B' num2str(e) '.tgt'],orderfields(ChunkTrainReverse_G1,OrderFields));
                        dsave(['sml_CLRB_G2_L_B' num2str(e) '.tgt'],orderfields(ChunkTrainReverse_G2,OrderFields));
                    case 2
                        dsave(['sml_CLRB_G2_R_B' num2str(e) '.tgt'],orderfields(ChunkTrainReverse_G1,OrderFields));
                        dsave(['sml_CLRB_G1_L_B' num2str(e) '.tgt'],orderfields(ChunkTrainReverse_G2,OrderFields));
                        
                end
                
                clear X
                clear ChunkTrainReverse_G1
                clear ChunkTrainReverse_G2
            end
            %% Chunk Recall Block
            Trials = 1:66;
            ...
            for e = 1:4
                ...
                ChunkRecall_G1.iti(1:length(Trials),:) = 2000;
                ChunkRecall_G2.iti(1:length(Trials),:) = 2000;
                ...
                for i = 1:length(Trials)
                    ...
                    ChunkRecall_G1.cueP(p,:) = C3;
                    ChunkRecall_G2.cueP(p,:) = C3;
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_CRB_G1_R_B' num2str(e) '.tgt'],orderfields(ChunkRecall_G1,OrderFields));
                        dsave(['sml_CRB_G2_L_B' num2str(e) '.tgt'],orderfields(ChunkRecall_G2,OrderFields));
                    case 2
                        dsave(['sml_CRB_G2_R_B' num2str(e) '.tgt'],orderfields(ChunkRecall_G1,OrderFields));
                        dsave(['sml_CRB_G1_L_B' num2str(e) '.tgt'],orderfields(ChunkRecall_G2,OrderFields));
            ...
            for e = 1:30
                SequenceLearn_G1.cueP(1:length(Trials),:) = repmat(C3Seq,(length(Trials)),1);
                SequenceLearn_G2.cueP(1:length(Trials),:) = repmat(C3Seq,(length(Trials)),1);
                
                SequenceLearn_G2.cueC(2:2:length(Trials),:) = cellstr(repmat('£',length(Trials)/2,1));
                SequenceLearn_G1.cueC(2:2:length(Trials),:) = cellstr(repmat('£',length(Trials)/2,1));
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_SLB_G1_R_B' num2str(e) '.tgt'],orderfields(SequenceLearn_G1,OrderFields));
                        dsave(['sml_SLB_G2_L_B' num2str(e) '.tgt'],orderfields(SequenceLearn_G2,OrderFields));
                    case 2
                        dsave(['sml_SLB_G2_R_B' num2str(e) '.tgt'],orderfields(SequenceLearn_G1,OrderFields));
                        dsave(['sml_SLB_G1_L_B' num2str(e) '.tgt'],orderfields(SequenceLearn_G2,OrderFields));
            ...
            %% Sequence Learning Block reversed
            
            Trials = 1:24;
            for e = 1:30
                SequenceLearnReverse_G1.cueP(1:length(Trials),:) = repmat(C3Seq,(length(Trials)),1);
                SequenceLearnReverse_G2.cueP(1:length(Trials),:) = repmat(C3Seq,(length(Trials)),1);
                
                SequenceLearnReverse_G2.cueC(1:2:length(Trials),:) = cellstr(repmat('£',length(Trials)/2,1));
                SequenceLearnReverse_G1.cueC(1:2:length(Trials),:) = cellstr(repmat('£',length(Trials)/2,1));
                
                SequenceLearnReverse_G1.iti(1:length(Trials),:) = 500;
                SequenceLearnReverse_G2.iti(1:length(Trials),:) = 500;
                
                SequenceLearnReverse_G1.hand(1:length(Trials),:) = 2;
                SequenceLearnReverse_G2.hand(1:length(Trials),:) = 1;
                
                SequenceLearnReverse_G1.sounds(1:length(Trials),:) = 1;
                SequenceLearnReverse_G2.sounds(1:length(Trials),:) = 1;
                
                X = sample_wor(SequenceNumb,length(SequenceNumb));
                p = 2;
                l = 1;
                for i = 1:(length(Trials)/2)
                    SequenceLearnReverse_G1.cueS(p-1:p,:) = C1(X(l));
                    SequenceLearnReverse_G2.cueS(p-1:p,:) = C1(X(l));
                    
                    SequenceLearnReverse_G1.cueC(p,:) = regexprep(cellstr(strjoin(C2(SeqChunksG1(X(l),:))')),'\s','');
                    SequenceLearnReverse_G2.cueC(p,:) = regexprep(cellstr(strjoin(C2(SeqChunksG2(X(l),:))')),'\s','');
                    
                    SequenceLearnReverse_G1.press1(p-1:p,:) = SeqG1(X(l),1);
                    SequenceLearnReverse_G1.press2(p-1:p,:) = SeqG1(X(l),2);
                    SequenceLearnReverse_G1.press3(p-1:p,:) = SeqG1(X(l),3);
                    SequenceLearnReverse_G1.press4(p-1:p,:) = SeqG1(X(l),4);
                    SequenceLearnReverse_G1.press5(p-1:p,:) = SeqG1(X(l),5);
                    SequenceLearnReverse_G1.press6(p-1:p,:) = SeqG1(X(l),6);
                    SequenceLearnReverse_G1.press7(p-1:p,:) = SeqG1(X(l),7);
                    SequenceLearnReverse_G1.press8(p-1:p,:) = SeqG1(X(l),8);
                    SequenceLearnReverse_G1.press9(p-1:p,:) = SeqG1(X(l),9);
                    
                    
                    SequenceLearnReverse_G2.press1(p-1:p,:) = SeqG2(X(l),1);
                    SequenceLearnReverse_G2.press2(p-1:p,:) = SeqG2(X(l),2);
                    SequenceLearnReverse_G2.press3(p-1:p,:) = SeqG2(X(l),3);
                    SequenceLearnReverse_G2.press4(p-1:p,:) = SeqG2(X(l),4);
                    SequenceLearnReverse_G2.press5(p-1:p,:) = SeqG2(X(l),5);
                    SequenceLearnReverse_G2.press6(p-1:p,:) = SeqG2(X(l),6);
                    SequenceLearnReverse_G2.press7(p-1:p,:) = SeqG2(X(l),7);
                    SequenceLearnReverse_G2.press8(p-1:p,:) = SeqG2(X(l),8);
                    SequenceLearnReverse_G2.press9(p-1:p,:) = SeqG2(X(l),9);
                    
                    
                    SequenceLearnReverse_G1.seqNumb(p-1:p,:) = SequenceNumb(X(l));
                    SequenceLearnReverse_G2.seqNumb(p-1:p,:) = SequenceNumb(X(l));
                    
                    SequenceLearnReverse_G1.isScan = zeros(length(Trials),1);
                    SequenceLearnReverse_G2.isScan = zeros(length(Trials),1);
                    
                    % one for trained sequence
                    SequenceLearnReverse_G1.seqType = ones(length(Trials),1);
                    SequenceLearnReverse_G2.seqType = ones(length(Trials),1);
                    
                    SequenceLearnReverse_G1.FoSEX = repmat([1:2]',length(Trials)/2,1);
                    SequenceLearnReverse_G2.FoSEX = repmat([1:2]',length(Trials)/2,1);
                    
                    SequenceLearnReverse_G1.isMetronome = zeros(length(Trials),1);
                    SequenceLearnReverse_G2.isMetronome = zeros(length(Trials),1);
                    
                    SequenceLearnReverse_G1.lastTrial = zeros(length(Trials),1);
                    SequenceLearnReverse_G2.lastTrial = zeros(length(Trials),1);
                    
                    SequenceLearnReverse_G1.startTime = zeros(length(Trials),1);
                    SequenceLearnReverse_G2.startTime = zeros(length(Trials),1);
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_SLRB_G1_R_B' num2str(e) '.tgt'],orderfields(SequenceLearnReverse_G1,OrderFields));
                        dsave(['sml_SLRB_G2_L_B' num2str(e) '.tgt'],orderfields(SequenceLearnReverse_G2,OrderFields));
                    case 2
                        dsave(['sml_SLRB_G2_R_B' num2str(e) '.tgt'],orderfields(SequenceLearnReverse_G1,OrderFields));
                        dsave(['sml_SLRB_G1_L_B' num2str(e) '.tgt'],orderfields(SequenceLearnReverse_G2,OrderFields));
                        
                end
                clear X
                clear SequenceLearnReverse_G1
                clear SequenceLearnReverse_G2
            end
            
            %% Sequence Memory Block
            
            Trials = 1:24;
            for e =  1:65
                
                SequenceMemory_G1.cueC =cellstr(repmat('£',length(Trials),1));
                SequenceMemory_G2.cueC =cellstr(repmat('£',length(Trials),1));
                
                SequenceMemory_G1.cueP = repmat(C3Seq,(length(Trials)),1);
                SequenceMemory_G2.cueP = repmat(C3Seq,(length(Trials)),1);
                
                SequenceMemory_G1.iti(1:length(Trials),:) = 500;
                SequenceMemory_G2.iti(1:length(Trials),:) = 500;
                
                SequenceMemory_G1.hand(1:length(Trials),:) = 2;
                SequenceMemory_G2.hand(1:length(Trials),:) = 1;
                
                SequenceMemory_G1.sounds(1:length(Trials),:) = 1;
                SequenceMemory_G2.sounds(1:length(Trials),:) = 1;
                
                
                SequenceMemory_G1.isScan = zeros(length(Trials),1);
                SequenceMemory_G2.isScan = zeros(length(Trials),1);
                
                % one for trained sequence
                SequenceMemory_G1.seqType = ones(length(Trials),1);
                SequenceMemory_G2.seqType = ones(length(Trials),1);
                
                SequenceMemory_G1.FoSEX = repmat([1:2]',length(Trials)/2,1);
                SequenceMemory_G2.FoSEX = repmat([1:2]',length(Trials)/2,1);
                
                SequenceMemory_G1.isMetronome = zeros(length(Trials),1);
                SequenceMemory_G2.isMetronome = zeros(length(Trials),1);
                
                SequenceMemory_G1.lastTrial = zeros(length(Trials),1);
                SequenceMemory_G2.lastTrial = zeros(length(Trials),1);
                
                SequenceMemory_G1.startTime = zeros(length(Trials),1);
                SequenceMemory_G2.startTime = zeros(length(Trials),1);
                
                X = sample_wor(SequenceNumb,length(SequenceNumb));
                p = 1;
                l = 1;
                for i = 1:(length(Trials)/2)
                    SequenceMemory_G1.cueS(p:p+1,:) = C1(X(l));
                    SequenceMemory_G2.cueS(p:p+1,:) = C1(X(l));
                    
                    SequenceMemory_G1.press1(p:p+1,:) = SeqG1(X(l),1);
                    SequenceMemory_G1.press2(p:p+1,:) = SeqG1(X(l),2);
                    SequenceMemory_G1.press3(p:p+1,:) = SeqG1(X(l),3);
                    SequenceMemory_G1.press4(p:p+1,:) = SeqG1(X(l),4);
                    SequenceMemory_G1.press5(p:p+1,:) = SeqG1(X(l),5);
                    SequenceMemory_G1.press6(p:p+1,:) = SeqG1(X(l),6);
                    SequenceMemory_G1.press7(p:p+1,:) = SeqG1(X(l),7);
                    SequenceMemory_G1.press8(p:p+1,:) = SeqG1(X(l),8);
                    SequenceMemory_G1.press9(p:p+1,:) = SeqG1(X(l),9);
                    
                    SequenceMemory_G2.press1(p:p+1,:) = SeqG2(X(l),1);
                    SequenceMemory_G2.press2(p:p+1,:) = SeqG2(X(l),2);
                    SequenceMemory_G2.press3(p:p+1,:) = SeqG2(X(l),3);
                    SequenceMemory_G2.press4(p:p+1,:) = SeqG2(X(l),4);
                    SequenceMemory_G2.press5(p:p+1,:) = SeqG2(X(l),5);
                    SequenceMemory_G2.press6(p:p+1,:) = SeqG2(X(l),6);
                    SequenceMemory_G2.press7(p:p+1,:) = SeqG2(X(l),7);
                    SequenceMemory_G2.press8(p:p+1,:) = SeqG2(X(l),8);
                    SequenceMemory_G2.press9(p:p+1,:) = SeqG2(X(l),9);
                    
                    
                    SequenceMemory_G1.seqNumb(p:p+1,:) = SequenceNumb(X(l));
                    SequenceMemory_G2.seqNumb(p:p+1,:) = SequenceNumb(X(l));
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_SMB_G1_R_B' num2str(e) '.tgt'],orderfields(SequenceMemory_G1,OrderFields));
                        dsave(['sml_SMB_G2_L_B' num2str(e) '.tgt'],orderfields(SequenceMemory_G2,OrderFields));
                    case 2
                        dsave(['sml_SMB_G2_R_B' num2str(e) '.tgt'],orderfields(SequenceMemory_G1,OrderFields));
                        dsave(['sml_SMB_G1_L_B' num2str(e) '.tgt'],orderfields(SequenceMemory_G2,OrderFields));
                end
                
                clear x
                clear SequenceMemory
            end
            ...
            for i = 1:8
                switch GroupHand
                    case 1
                        ...
                        dsave(['sml_BL_G1_R_B' num2str(i) '.tgt'],orderfields(getrow(SequenceTestG1,B1:B2),OrderFields));
                        dsave(['sml_BL_G2_L_B' num2str(i) '.tgt'],orderfields(getrow(SequenceTestG2,B1:B2),OrderFields));
                        B1 = B1+30;
                        B2 = B2+30;
                    case 2
                        dsave(['sml_BL_G2_R_B' num2str(i) '.tgt'],orderfields(getrow(SequenceTestG1,B1:B2),OrderFields));
                        dsave(['sml_BL_G1_L_B' num2str(i) '.tgt'],orderfields(getrow(SequenceTestG2,B1:B2),OrderFields));
                        B1 = B1+30;
                        B2 = B2+30;
            ...
            for i = 1:4
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_BLM_G1_R_B' num2str(i) '.tgt'],orderfields(BLMG1B,OrderFields));
                        dsave(['sml_BLM_G2_L_B' num2str(i) '.tgt'],orderfields(BLMG2B,OrderFields));
                        B1 = B1+60;
                        B2 = B2+60;
                        
                    case 2
                        dsave(['sml_BLM_G2_R_B' num2str(i) '.tgt'],orderfields(BLMG1B,OrderFields));
                        dsave(['sml_BLM_G1_L_B' num2str(i) '.tgt'],orderfields(BLMG2B,OrderFields));
                        B1 = B1+60;
                        B2 = B2+60;
            ...
            for e = 1:blocks
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_PST_G1_R_B' num2str(e) '.tgt'],orderfields(PreScanTestG1,OrderFields));
                        dsave(['sml_PST_G2_L_B' num2str(e) '.tgt'],orderfields(PreScanTestG2,OrderFields));
                    case 2
                        dsave(['sml_PST_G2_R_B' num2str(e) '.tgt'],orderfields(PreScanTestG1,OrderFields));
                        dsave(['sml_PST_G1_L_B' num2str(e) '.tgt'],orderfields(PreScanTestG2,OrderFields));
            ...
            for e = 1:blocks
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_PSM_G1_R_B' num2str(e) '.tgt'],orderfields(PreScanMetG1,OrderFields));
                        dsave(['sml_PSM_G2_L_B' num2str(e) '.tgt'],orderfields(PreScanMetG2,OrderFields));
                    case 2
                        dsave(['sml_PSM_G2_R_B' num2str(e) '.tgt'],orderfields(PreScanMetG1,OrderFields));
                        dsave(['sml_PSM_G1_L_B' num2str(e) '.tgt'],orderfields(PreScanMetG2,OrderFields));
                end
            end
            ...
            ScanG1.cueC = cellstr(repmat('£',length(X2),1));
            
            ScanG1.cueS = cellstr(repmat('£',length(X2),1));
            
            ScanG1.iti(1:length(X2),:) = 0;
            
            ScanG1.sounds(1:length(X2),:) = 1;
            
            ScanG1.isScan(1:length(X2),:) = 1;
            
            ScanG1.isMetronome(1:length(X2),:) = 1;
            
            ScanG1.FoSEX(1:length(X2),:) = 1;
            
            ScanG1.lastTrial(1:length(X2),:) = 0;
            
            ScanG1.lastTrial(length(X2),:) = 1;
            
            %
            ScanG2.cueC = cellstr(repmat('£',length(X2),1));
            
            ScanG2.cueS = cellstr(repmat('£',length(X2),1));
            
            ScanG2.iti(1:length(X2),:) = 0;
            
            ScanG2.sounds(1:length(X2),:) = 1;
            
            ScanG2.isScan(1:length(X2),:) = 1;
            
            ScanG2.isMetronome(1:length(X2),:) = 1;
            
            ScanG2.FoSEX(1:length(X2),:) = 1;
            
            ScanG2.lastTrial(1:length(X2),:) = 0;
            
            ScanG2.lastTrial(length(X2),:) = 1;
            ...
            for e = 1:runs
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_Scan_G1_R_B' num2str(e) '.tgt'],orderfields(ScanG1,OrderFields));
                        dsave(['sml_Scan_G2_L_B' num2str(e) '.tgt'],orderfields(ScanG2,OrderFields));
                    case 2
                        dsave(['sml_Scan_G2_R_B' num2str(e) '.tgt'],orderfields(ScanG1,OrderFields));
                        dsave(['sml_Scan_G1_L_B' num2str(e) '.tgt'],orderfields(ScanG2,OrderFields));
            ...
            for e = 1:blocks
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_PSMGO_G1_R_B' num2str(e) '.tgt'],orderfields(PreScanGoG1,OrderFields));
                        dsave(['sml_PSMGO_G2_L_B' num2str(e) '.tgt'],orderfields(PreScanGoG2,OrderFields));
                    case 2
                        dsave(['sml_PSMGO_G2_R_B' num2str(e) '.tgt'],orderfields(PreScanGoG1,OrderFields));
                        dsave(['sml_PSMGO_G1_L_B' num2str(e) '.tgt'],orderfields(PreScanGoG2,OrderFields));
                end
            end
            ...
            ScanGoG1.cueC = cellstr(repmat('£',length(X2),1));
            
            ScanGoG1.cueS = cellstr(repmat('£',length(X2),1));
            
            ScanGoG1.iti(1:length(X2),:) = 0;
            
            ScanGoG1.sounds(1:length(X2),:) = 1;
            
            ScanGoG1.isScan(1:length(X2),:) = 1;
            
            ScanGoG1.isMetronome(1:length(X2),:) = 2;
            
            ScanGoG1.FoSEX(1:length(X2),:) = 1;
            
            ScanGoG1.lastTrial(1:length(X2),:) = 0;
            
            ScanGoG1.lastTrial(length(X2),:) = 1;
            
            %
            ScanGoG2.cueC = cellstr(repmat('£',length(X2),1));
            
            ScanGoG2.cueS = cellstr(repmat('£',length(X2),1));
            
            ScanGoG2.iti(1:length(X2),:) = 0;
            
            ScanGoG2.sounds(1:length(X2),:) = 1;
            
            ScanGoG2.isScan(1:length(X2),:) = 1;
            
            ScanGoG2.isMetronome(1:length(X2),:) = 2;
            
            ScanGoG2.FoSEX(1:length(X2),:) = 1;
            
            ScanGoG2.lastTrial(1:length(X2),:) = 0;
            
            ScanGoG2.lastTrial(length(X2),:) = 1;
            ...
            for e = 1:runs
                ...
                switch GroupHand
                    case 1
                        dsave(['sml_ScanGo_G1_R_B' num2str(e) '.tgt'],orderfields(ScanGoG1,OrderFields));
                        dsave(['sml_ScanGo_G2_L_B' num2str(e) '.tgt'],orderfields(ScanGoG2,OrderFields));
                    case 2
                        dsave(['sml_ScanGo_G2_R_B' num2str(e) '.tgt'],orderfields(ScanGoG1,OrderFields));
                        dsave(['sml_ScanGo_G1_L_B' num2str(e) '.tgt'],orderfields(ScanGoG2,OrderFields));
