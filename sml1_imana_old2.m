...
subj_name  = {'p01a','p01b','p01c','p02a','p02b'};  % same pilot subject
loc_AC     = {[-106 -163 -172],...
    [-106 -163 -172],...
    [-106 -163 -172],...
    [-108 -166 -166],...
...
switch(what)
    ...
    case 'GLM_make'                                                         % STEP 3.1   :  Make the SPM.mat and SPM_info.mat files (prep the GLM)
        ...
        delay        = [2.0 2.0 2.0 2.0 2.0];                                         % adjusting hrf per subject based on extracted timeseries!
    ...
    case 'SUIT_process_all'  
        % example: sml1_imana('process_suit',2,4,'contrast')
    ...
    case 'ROI_define'                                                       % STEP 5.1   :  Define ROIs
        ...
        for s=sn
            ...
            for h=1:2
                ...
                caretSubjDir = fullfile(caretDir,['x' subj_name{4}]);   % same subject - anatomy
                suitSubjDir = fullfile(suitDir,'anatomicals',subj_name{s});
